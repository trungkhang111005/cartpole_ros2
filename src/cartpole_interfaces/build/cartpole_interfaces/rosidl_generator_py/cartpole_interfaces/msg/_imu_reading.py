...
class Metaclass_ImuReading(type):
    """Metaclass of message 'ImuReading'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cartpole_interfaces.msg.ImuReading')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__imu_reading
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__imu_reading
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__imu_reading
            cls._TYPE_SUPPORT = module.type_support_msg__msg__imu_reading
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__imu_reading
...
class ImuReading(metaclass=Metaclass_ImuReading):
    """Message class 'ImuReading'."""
