...
static const _ImuReading_type_support_symbol_names_t _ImuReading_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cartpole_interfaces, msg, ImuReading)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartpole_interfaces, msg, ImuReading)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cartpole_interfaces, msg, ImuReading)() {
  return &::cartpole_interfaces::msg::rosidl_typesupport_c::ImuReading_message_type_support_handle;
}
